                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="artist-form">
                            ...
                            @endif
                            <form action="{{url('admin/terms-and-conditions/submit')}}" class="form"
                                  role="form" autocomplete="off" id="create-form"
                                  method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                @if(isset($policy) && $policy != null)
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label form-control-label">Existing Policy
                                            Banner</label>
                                        <div class="col-lg-9">
                                            <img src="{{asset('images/policy/thumbs/'.$policy->image)}}"
                                                 alt="policy banner">
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Policy Banner
                                        @if(!isset($policy) || $policy == null)<span class="req">*</span>@endif
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Policy Description
                                        <span class="req">*</span>
                                    </label>
                                    <div class="col-lg-9">
