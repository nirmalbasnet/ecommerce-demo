...
@section('main-section')
    <div class="container-fluid about-page  wow fadeIn animated" data-wow-duration="500ms" data-wow-delay="300ms"
        ...
        <div class="image-aboutus-banner" style="margin-top:70px; background: linear-gradient(rgba(0,0,0,.7), rgba(0,0,0,.7)), url({{asset('images/policy/'.$aboutUs->image)}});">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="lg-text">Terms & Conditions</h1>
